...
echo -e "    echo 'alias skillhelp=\"\$HOME/.skillhelp/skillhelp.sh\"' >> ~/.bashrc && source ~/.bashrc"
echo ""
echo -e "  ${Y}zsh${RST}   ${D}(~/.zshrc)${RST}"
echo -e "    echo 'alias skillhelp=\"\$HOME/.skillhelp/skillhelp.sh\"' >> ~/.zshrc && source ~/.zshrc"
echo ""
echo -e "  ${Y}fish${RST}  ${D}(~/.config/fish/config.fish)${RST}"
echo -e "    echo 'alias skillhelp \"\$HOME/.skillhelp/skillhelp.sh\"' >> ~/.config/fish/config.fish && source ~/.config/fish/config.fish"
echo ""
